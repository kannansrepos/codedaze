...
export const Prompt = {
  ...
  prompt:
    "I want to write an blog post for '{TITLE}' can you give me 5 to 10 min to read about this topic for blog post with the bellow object format in JSON object  {id:'',language:language:'angular or  docker or  dotnet  or nextjs or or react based on the post',shortTitle:'',title:'',description:'',category:'',readMin:1,section:[{title:'',content:HTML format type text,code:sample code] don't add any special characters",
};
